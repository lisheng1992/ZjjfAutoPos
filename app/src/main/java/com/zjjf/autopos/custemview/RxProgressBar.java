...
/**
 *  自定义带数据的加载进度条
 * Created by Yekai on 2017/11/29.
 */
...
public class RxProgressBar extends View implements Runnable{
    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            pauseColor = ta.getColor(R.styleable.FlikerProgressBar_stopColor, Color.parseColor("#0099cc"));
            finishColor = ta.getColor(R.styleable.FlikerProgressBar_finishColor, Color.parseColor("#0099cc"));
