...
import com.zjjf.autopos.utils.UIUtils;
...
public class CustomCircleProgressBar extends View {
    ...
    public CustomCircleProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        outsideRadius = a.getDimension(R.styleable.CustomCircleProgressBar_outside_radius, UIUtils.dip2px(getContext(), 60.0f));
        insideColor = a.getColor(R.styleable.CustomCircleProgressBar_inside_color, ContextCompat.getColor(getContext(), R.color.color_eeeeee));
        progressTextColor = a.getColor(R.styleable.CustomCircleProgressBar_progress_text_color, ContextCompat.getColor(getContext(), R.color.grey_666666));
        progressTextSize = a.getDimension(R.styleable.CustomCircleProgressBar_progress_text_size, UIUtils.dip2px(getContext(), 40.0f));
        progressWidth = a.getDimension(R.styleable.CustomCircleProgressBar_progress_width, UIUtils.dip2px(getContext(), 10.0f));
