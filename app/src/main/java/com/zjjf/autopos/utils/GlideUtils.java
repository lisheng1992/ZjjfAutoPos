...
public class GlideUtils {
   ...
   /**
    ...
    //给父控件设置背景
    public static void loadViewBackground(Context mContext, String path, final View mView, int weidth, int height){
        Glide.with(mContext).load(path).asBitmap().diskCacheStrategy(DiskCacheStrategy.SOURCE).into(new SimpleTarget<Bitmap>(weidth,height) {
            @Override
