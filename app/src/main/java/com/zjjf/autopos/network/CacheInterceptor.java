...
public class CacheInterceptor implements Interceptor {
    ...
    public CacheInterceptor() {
        this(String.format("max-age=%d", maxStaleOnline));
    }

    public CacheInterceptor(String cacheControlValue) {
        this(cacheControlValue, String.format("max-age=%d", maxStale));
    }

    public CacheInterceptor(String cacheControlValueOffline, String cacheControlValueOnline) {
